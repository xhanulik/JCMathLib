...
public class SetBitTest {
    ...
    public void oneByte_firstBit_one() {
        ...
        CTUtil.ctSetBit(data, (short) data.length, (byte) 1, 0);
    ...
    public void oneByte_firstBit_zero() {
        ...
        CTUtil.ctSetBit(data, (short) data.length, (byte) 0, 0);
    ...
    public void oneByte_lastBit_one() {
        byte[] data = {0b00000000};
        CTUtil.ctSetBit(data, (short) data.length, (byte) 1, 7);
    ...
    public void oneByte_lastBit_zero() {
        ...
        CTUtil.ctSetBit(data, (short) data.length, (byte) 0, 7);
        Assertions.assertArrayEquals(new byte[]{0b00000001}, data);
    }
    ...
    public void twoBytes_lastBit_one() {
        ...
        CTUtil.ctSetBit(data, (short) data.length, (byte) 1, 15);
    ...
    public void twoBytes_lastBit_zero() {
        ...
        CTUtil.ctSetBit(data, (short) data.length, (byte) 0, 15);
